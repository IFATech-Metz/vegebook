...
<!--        Menu SECTION           -->           
        ...
        <nav id="menu">
            <ul>
                ...
                <li><a href='index.php?type=fruits'>Fruits</a></li>
                <li><a href='index.php?type=legumes'>Légumes</a></li>
                <li><a href='index.php?type=plantes'>Plantes</a></li>
            </ul>
        </nav>
 ...
 <!--        Menu SECTION            -->   
     ...
     <?php if(!isset($_GET['type'])){?>   
            <section id="main">
                ...
                <h1>Bienvenue sur Vegebook, le jardin connecté !</h1>
