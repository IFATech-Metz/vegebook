 <?php
    ...
    if(isset($_GET['id']) && isset($_GET['type'])){
            ...
            $estimation_input = $elements[$id]['recolte'];
...
// stockage des informations du légume pour afficher leur contenu dans les input du formulaire (pré-selection)
    ...
    // si le bouton de validation de la modification est pressé, 
                    ...
                    $dernier = $_POST['dernier-arrosage'];
                    $notes = $_POST['notes'];
    ...
    // suppression dans l'array des informations de l'element que l'user est en train de modifier 
           ...
           'name' => $name,
           'img'=> $img,
           'name_fr'=> $password_confirm,
           'plantation'=> $civility,
           'quantite' => $lastname,
           'estimation' => $firstname,
           'freq_arrosage' => $birth_date,
           'adernier_arrosage' => $address,
